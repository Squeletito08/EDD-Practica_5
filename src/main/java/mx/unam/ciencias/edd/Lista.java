...
public class Lista<T> implements Coleccion<T> {
    ...
    public void inserta(int i, T elemento) {
        ...
        if (i < 1){
            ...
            nodoE.anterior = nodoAux.anterior; 
            nodoE.siguiente = nodoAux; 
            nodoE.anterior.siguiente = nodoE; 
            nodoE.siguiente.anterior = nodoE; 
        return;
        }        
    }

    /**
     * Metodo auxiliar para buscar un nodo en la lista dado un indice 
     * @param i el índice del elemento a buscar
     * @return el nodo que corresponde al indice recibido
     *         null en caso de que dicho indice sea invalido o el 
     *         nodo no exista
     * */
    ...
    /**
     * Metodo auxiliar para encontrar el Nodo que contiene un objeto
     * @param e el elemento a buscar en la lista
     * @return el nodo que contenga dicho objeto
               null en caso de que el objeto sea null o no exista un nodo con dicho objeto 
     */
    ...
    /**
     * Metodo auxiliar para eliminar un nodo de la lista
     * @param Nodo el nodo a liminar de la lista
     */
    ...
    /**
     * Implementacion de algoritmo auxiliar para concatenar 2 listas ordenadas
     * @param compardor Un comparador para saber cuando un elemento de la 
     *                        primera lista es mayor, menor o igual a uno de la 
     *                        segunda, y 2 listas ordenadas
     * @param l1 Una lista ordenada
     * @param l2 Una lista ordenada
     * @return Una lista ordenada con los elementos de la primera y segunda lista
     */
